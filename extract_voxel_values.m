...
function [Ym R info] = extract_voxel_values(mask, data, th)
    ...
    for r = 1:size(mask,1)
        ...
        switch e
            ...
            case {'.nii','.img'}
                ...
                [x,y,z] = ind2sub(size(maskdata),find(maskdata > th)); % revise here for thresholding
                xyz = [x y z]';
        end
...
end % end of extract_voxel_values
