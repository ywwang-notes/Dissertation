...
sidlst = {[2764 2526 3552 0739 2167 0893 3034 2809 1697 1091 2054 0679 ...
          ...
          [0567 4087 1676 4765 2187 1710 4958 3973 2055 4599 2372 ...
...
for i=1:2
    ...
    for s=1:length(subjects)
        scan = sprintf('%swrcorr0_%04i_%s_5L.nii', folder, subjects(s), event);
        if ~exist(scan)
            disp(sprintf('%04i skipped', subjects(s)));
            continue;
        end
...
matlabbatch{1}.spm.stats.factorial_design.dir = {[folder event '/' cond{1} cond{2}]};
...
matlabbatch{3}.spm.stats.con.consess{1}.tcon.name = 'cond1_cond2';
matlabbatch{3}.spm.stats.con.consess{1}.tcon.weights = [1 -1];
matlabbatch{3}.spm.stats.con.consess{1}.tcon.sessrep = 'none';
matlabbatch{3}.spm.stats.con.consess{2}.tcon.name = 'cond2_cond1';
matlabbatch{3}.spm.stats.con.consess{2}.tcon.weights = [-1 1];
matlabbatch{3}.spm.stats.con.consess{2}.tcon.sessrep = 'none';
matlabbatch{3}.spm.stats.con.consess{3}.tcon.name = 'cond1cond2_mean';
