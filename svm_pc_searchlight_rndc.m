...
for sess = 1:5
    ...
    movefile('searchlight_0001.nii', ...
        sprintf('corr_f%i_%i_%s_b%i_%s%s_%imm_%s_rndc.nii', ...
        nFolds, th_ratio*10, sid, sess, events{e1}, events{e2}, radius, k_func));
    movefile('searchlight_0002.nii', ...
        sprintf('sens_f%i_%i_%s_b%i_%s%s_%imm_%s_rndc.nii', ...
        nFolds, th_ratio*10, sid, sess, events{e1}, events{e2}, radius, k_func));
    movefile('searchlight_0003.nii', ...
        sprintf('spec_f%i_%i_%s_b%i_%s%s_%imm_%s_rndc.nii', ...
        nFolds, th_ratio*10, sid, sess, events{e1}, events{e2}, radius, k_func));
